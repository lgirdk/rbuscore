 ...
 **/
rtError
rtMessage_GetBinaryData(rtMessage message, char const* name, const void ** ptr, uint32_t *size);
...
/*Begin private headers. Meant for internal rbus use only.*/
void 
rtMessage_BeginMetaSectionWrite(rtMessage message);
void 
rtMessage_EndMetaSectionWrite(rtMessage message);
void 
rtMessage_BeginMetaSectionRead(rtMessage message);
void 
rtMessage_EndMetaSectionRead(rtMessage message);
#ifdef __cplusplus
}
#endif
#endif
